    ...
    >
      ...
      >
        ...
        <div class="flex items-center">
          ...
          <div
            class="hidden md:flex items-center justify-end md:flex-1 lg:w-0 py-2"
          >
            <a
              href="#"
              class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm 
              text-base font-bold text-black hover:text-gray-500 border-black border-2 border-t border-b border-r"
              >comprar
            </a>
          </div>
        </div>
